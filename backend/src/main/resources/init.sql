...
-- Note: To log in, make sure BCrypt matches admin123. The actual hash might need to be generated by Spring Boot on startup if the static one doesn't work.
-- Alternatively, we can let Spring Boot generate it in a DataLoader.
